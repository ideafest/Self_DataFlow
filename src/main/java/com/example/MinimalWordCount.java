...
//    options.setProject("zimetrics");
    // CHANGE 2/3: Your Google Cloud Storage path is required for staging local files.
//    options.setStagingLocation("/home/zimetrics/Documents/staging_Loc");
    ...
    p.apply(TextIO.Read.from("gs://dataflow-samples/shakespeare/*"))
     ...
     .apply(TextIO.Write.to("/home/zimetrics/Documents/staging_Loc/output.txt"));
