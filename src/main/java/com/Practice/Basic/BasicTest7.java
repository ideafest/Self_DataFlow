...
public class BasicTest7 {
	...
	public static final String dncList = "vantage-167009:Xtaas.dnclist";
	...
	static PCollection<TableRow> joinOperation(PCollection<TableRow> stringPCollection1, PCollection<TableRow> stringPCollection2
			, List<Field> fieldMetaDataList1, List<Field> fieldMetaDataList2, String table1Prefix, String table2Prefix){
		
		PCollection<KV<String, TableRow>> kvpCollection1 = stringPCollection1.apply(ParDo.named("FormatData1").of(new ReadFromDncList()));
		PCollection<KV<String, TableRow>> kvpCollection2 = stringPCollection2.apply(ParDo.named("FormatData2").of(new ReadFromCMPGN()));
	...
	public static void main(String[] args) {
		...
		PCollection<TableRow> source1Table = pipeline.apply(BigQueryIO.Read.named("Source1Reader").from(dncList));
		...
		PCollection<TableRow> rowPCollection = joinOperation(source1Table, source2Table, fieldMetaDataList1, fieldMetaDataList2, "A_", "B_");
